...
\begin{description}
	...
	\item \todo[color=cyan]{Augmentation des parts de marché sur moyen/long terme} déduite de l'item précédent.
	\item \todo[color=cyan]{Réduire Lead Time / Processing Time => temps prise en compte / temps livré. Une lead time long est synonyme de nombreuses validation au sein d'une hiérarchie, qui peuvent potentiellemnt être réduit en réduisant les intermédiaire inutile.Réduire temps entre "en cours de développement" et "livré en prod".} 
	\item \todo[color=cyan]{Rédiger un KPI sur le PCA, PRA, reprise d'activité, temps de restauration de services réduit}
