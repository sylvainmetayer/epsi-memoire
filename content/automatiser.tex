...
\begin{table}[H]
	...
	\begin{adjustbox}{width=0.95\textwidth,center=\textwidth} 
		\begin{tabular}{|l|l|l|l|l|}
			\hline
			\diagbox{type de test}{objectif} & Fonctionnement unitaire & Règle métier & Développement & Interaction \\ \hline
