...
\epigraph{Neuf femmes ne font pas un enfant en un mois}{\citetitle{manmonth} - \citeauthor{manmonth} \cite{manmonth}}
...
\newImage{0.35}{kanban.jpg}{Représentation d'un tableau Kanban - Source : https://commons.wikimedia.org/wiki/File:Kanban\_board\_example.jpg}{kanban}
