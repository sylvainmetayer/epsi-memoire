...
Les opérations sont à prévoir pour tous les cas pouvant intervenir, qu'il s'agissent de déploiement d'une nouvelle version, d'un \gls{hotfix} (voir annexe \ref{annexe:hotfix-naq}) ou de la construction de module étant réutilisés par d'autres applications (voir annexe \ref{annexe:commons-modules}).
...
Chaque projet va souvent dépendre de dépendances. Dans le cas d'un projet \gls{PHP}, on va souvent retrouver des dépendances via composer\todo{continuer la.}
