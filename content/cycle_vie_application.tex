...
\begin{itemize}
	...
	\item Les \emph{won't have} sont des fonctionnalités intéressantes mais qui ne sont pas prévues pour le moment. Elles pourront néanmoins être étudiées pour pouvoir être implémentées plus tard. \todo{missing example}
\end{itemize}
