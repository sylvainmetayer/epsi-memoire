...
\emph{Maintenant que nous avons vu les différentes étapes du cycle de vie d'une application et que nous avons vu qu'il y avait un intérêt à mettre en place une démarche d'automatisation au sein d'un projet, nous allons voir dans la section suivante comment mettre cela en place de façon plus concrète.}