...
\newImage{0.25}{etsy-github.png}{Profil \github{} d'\etsy{} ou l'on peut voir que l'entreprise a ouvert plus de 60 applications au public}{etsy-github}
...
\todo[color=cyan]{Terminer post mortem avec third way devops ref}
...
\todo[color=cyan]{Difficulté d'avoir la panacée, 1-2 pages}
