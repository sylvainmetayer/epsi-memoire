\section{Schéma simplifié du cycle de vie d'un projet}\label{annexe:cycleVieProjet}
\newImageAnnexe[H]{0.75}{cycle-vie-projet.png}{cycleVieProjetImage}{Schéma simplifié du cycle de vie d'un projet}
