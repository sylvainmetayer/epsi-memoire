...
\newAcronym{LDAP}{LDAP}{TODO}{TODO}
\newAcronym{SQL}{SQL}{Structured Query Language}{TODO}
\newAcronym{LAMP}{LAMP}{Linux, Apache, MySQL, PHP}{TODO}
\newAcronym{vm}{VM}{Virtual Machine}{Machine virtuelle, TODO}
\newAcronym{irc}{IRC}{Internet Relay Chat}{TODO}
\newAcronym{ftp}{FTP}{File Tranfert Protocol}{TODO}
\newAcronym{mvp}{MVP}{Minimum Viable Product}{TODO}
\newAcronym{vtc}{VTC}{Voitures transport avec chauffeur}{TODO}
\newAcronym{SLA}{SLA}{Service Level Agreement}{TODO}
