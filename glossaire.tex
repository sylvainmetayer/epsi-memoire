...
\newAcronym{API}{API}{Application Programming Interface}{Ensemble de classes ou méthodes exposées publiquement pour être utilisées par d'autres services}
...
\newAcronym{DMZ}{DMZ}{Demilitarized Zone}{Réseau contenant des machines isolées du réseau local sujettes à être accédée via Internet}
...
\newAcronym{SCM}{SCM}{Source Code Management}{Permet de stocker et suivre les modifications d'un ensemble de fichier de façon décentralisée.}
